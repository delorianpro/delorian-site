        ...
        <div className={`${styles.faleConosco} ${styles.item4}`}>
          ...
          <a href="#" onClick={handleRedirectWhatsapp}>
            <p className={styles.whatsappText}>
              <Image src={"/assets/whatsIconFooter.svg"} alt="WhatsApp Icon" width={150} height={150} className={styles.whatsappImage} />
              (41) 9 8501-1909
            </p>
          </a>
          <a href="#" onClick={handleRedirectFacebook}>
            <p className={styles.facebookText}>
              <Image src={"/assets/facebookIconFooter.svg"} alt="Facebook Icon" width={150} height={150}  className={styles.facebookImage}/>
              @delorianpro
            </p>
          </a>
          <a href="#" onClick={handleRedirectInstagram}>
            <p className={styles.instagramText}>
              <Image src={"/assets/instagramIconFooter.svg"} alt="Instagram Icon" width={150} height={150} className={styles.instagramImage}/>
              @delorianpro
            </p>
          </a>
        </div>
