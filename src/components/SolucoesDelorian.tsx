  ...
  const solucoes = [
    {
      ...
      images: [
        { src: "/assets/instalacao.svg", alt: "Instalação de motor", width: 360, height: 162 },
    ...
    },
    {
      ...
      images: [
        { src: "/assets/naoFuncionando.svg", alt: "Instalação de motor", width: 360, height: 162 },
    ...
    },
    {
      ...
      images: [
        { src: "/assets/semForca.svg", alt: "Instalação de motor", width: 360, height: 162 },
    ...
    },
    {
      ...
      images: [
        { src: "/assets/unidirecional.svg", alt: "Instalação de motor", width: 360, height: 162 },
    ...
    },
    {
      ...
      images: [
        { src: "/assets/barulhento.svg", alt: "Instalação de motor", width: 360, height: 162 },
    ...
    },
    {
      ...
      images: [
        { src: "/assets/batendo.svg", alt: "Instalação de motor", width: 294, height: 169 },
    ...
    },
    {
      ...
      images: [
        { src: "/assets/controle.svg", alt: "Instalação de motor", width: 165, height: 137 },
      ]
    },
    {
      id: 8,
      ...
      images: [
        { src: "/assets/iconMais.svg", alt: "Instalação de motor", width: 120, height: 120, className: styles.imageMais },
      ]
    }
  ];
  ...
  return (
    <div className={styles.delorianSolucoesContainer}>
      <div className={styles.titleDelorianSolucoes}>
        ...
        <h1 id="delorianResolve" className={styles.delorianResolve}>Delorian resolve</h1>
      </div>
